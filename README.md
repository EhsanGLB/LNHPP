# LNHPP
This is a post-processing for local normalized helicity based on foam-extend-4.1.

## Math equation
$$ LNH = \int_0^T \mid WSS \mid \ dt $$
...
```bash
git clone https://github.com/EhsanGLB/LNHPP.git
cd LNHPP/LNHPP
wmake
cd ../case
```
